...
public class CleaningGreenMapper extends Mapper<Void, Group, Text, Text> {
    ...
    public void map(Void key, Group record, Context context) 
        ...
        try {
            String pickupDt = getStringValue(record, "lpep_pickup_datetime");
            String dropoffDt = getStringValue(record, "lpep_dropoff_datetime");
            ...
            if (valid) {
                ...
                cleanedRecord.put("lpep_pickup_datetime", pickupDt);
                cleanedRecord.put("lpep_dropoff_datetime", dropoffDt);
                ...
                cleanedRecord.put("taxi_type", "green");
